            ...
            <div class="col-12 col-md-8 col-xl-9 py-3">
                <div class="d-flex justify-content-center mt-3">
                    <form id="search-bar" class="d-flex">
                        <input class="form-control me-2" type="search" name="search"
                            placeholder="Recherche de message" aria-label="Search">
                    ...
                    <form class="btn-group" method="get">
                        <button type="submit" name="sort_newest" class="btn btn-outline-primary">Du plus récent <br>
                            au plus ancien</button>
                        <button type="submit" name="sort_oldest" class="btn btn-outline-primary">Du plus ancien <br>
                            au plus récent</button>
                    </form>
                </div>
                ...
                <?php
                    ...
                    while ($message = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '</form>';
                        echo '<p class="meta msg_hour">' . $message['date_heure_message'] . '</p>';
                        echo '</div>';
                    }
                ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <textarea name="message" placeholder="Message (280 caractères maximum)" required
