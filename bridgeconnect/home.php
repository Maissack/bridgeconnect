            ...
            <div class="col-12 col-md-8 col-xl-9 py-3">
                <div class="d-flex justify-content-center mt-3">
                    ...
                    <form class="btn-group" method="get">
                        <button type="submit" name="sort_newest" class="btn btn-outline-primary">From the most recent <br>
                        to the oldest</button>
                        <button type="submit" name="sort_oldest" class="btn btn-outline-primary">From the oldest <br>
                        to the most recent</button>
                    </form>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="connectModalLabel">New message</h5>
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <input type="submit" class="tweet" value="Connect">
                    </form>
                </div>
            </div>
        </div>
