            ...
            <div class="col-lg-6">
                <form method="post" class="mb-5">
                    <div class="form-outline mb-4">
                        <input type="text" name="identifiant" placeholder="Username or e-mail address" required class="form-control">
                    </div>
                    <div class="form-outline mb-4">
                        <input type="password" name="mot_de_passe" placeholder="Password" required class="form-control">
                    </div>
                    <?php if(isset($erreur)) { ?>
