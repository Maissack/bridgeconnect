...
if (isset($_POST['logout'])) {
    ...
    // Ou vous pouvez utiliser session_destroy() pour détruire toute la session
    // session_destroy();
}

?>

<!-- Un simple formulaire de déconnexion -->
<form method="post">
        ...
        <div class="col-12 col-md-4 col-xl-3 px-sm-2 px-0 bg-dark position-fixed">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item">
                            <a href="http://localhost/bridgeconnect/profile.php" class="nav-link align-middle px-0">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Please login or register to continue scrolling.</p>
...
<!-- Ouverture de la popup de post + ses fonctionnnalités -->
