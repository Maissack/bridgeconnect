                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form method="post" class="mx-1 mx-md-4">
                                        ...
                                        <div class="show-password">
                                            ...
                                            <span class="toggle-password" onclick="togglePassword()"><img src="https://img.icons8.com/ios-filled/24/000000/visible.png" alt="Icone oeil"></span>
                                        </div>
...
if($_POST) {
    ...
    if($_POST['mot_de_passe'] != $_POST['mot_de_passe_confirmation']) {
        ...
        $preparequest = $pdo->prepare("INSERT INTO user (nom, prenom, email, mot_de_passe) VALUES (?, ?, ?, ?)");
        ...
        $preparequest->bindParam(1, $nom);
        $preparequest->bindParam(2, $prenom);
        $preparequest->bindParam(3, $email);
        $preparequest->bindParam(4, $mot_de_passe);
